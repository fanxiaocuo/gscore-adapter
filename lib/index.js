 ...
 */
import { configFile, enabled, markOnline, onConfigReload } from "./config/index.js";
import { startClients, stopClients } from "./modules/client/index.js";
import { loadApps } from "./modules/loader/index.js";
import { checkConflicts } from "./modules/conflict/index.js";
import { initStats } from "./modules/stats/index.js";
import { initPassive } from "./modules/passive/index.js";
import { initImagebed } from "./utils/fileServer.js";
...
await initImagebed();
if (enabled())
    makeLog("info", "早柚核心适配器已载入", "GsCore");
else
    makeLog("warn", "早柚核心适配器已禁用（enable: false，改配置即时生效）", "GsCore");
