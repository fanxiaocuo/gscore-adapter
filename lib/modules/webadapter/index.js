 ...
 * 用户写在配置里的注释会被抹掉，这里不学。
 */
import { config, configFile, saveConfig, getWsConnections, appendConnection, updateConnection, removeConnection, enabled, } from "../../config/index.js";
...
function editConnection(body) {
    ...
    if (body.url !== undefined)
        patch.url = requireWsUrl(String(body.url));
    if (body.name !== undefined)
        patch.name = String(body.name).trim();
    if (body.bot_id !== undefined)
        patch.bot_id = String(body.bot_id);
