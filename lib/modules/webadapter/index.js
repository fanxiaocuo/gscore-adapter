 ...
 * 用户写在配置里的注释会被抹掉，这里不学。
 */
import { accountPlatform, config, configFile, saveConfig, getWsConnections, appendConnection, updateConnection, removeConnection, enabled, } from "../../config/index.js";
import { applyConnections, clients, reloadClients } from "../../modules/client/index.js";
import { effectiveAccounts, expandConnections, isAutomaticEndpoint, readIds, requireAccounts, } from "../../modules/client/expand.js";
 ...
 */
function connView(conf, i, runtime) {
...
function payload() {
    ...
    const connections = list.map((c, i) => connView(c, i, runtime.filter(r => r.sourceIndex === i)));
