...
export function About(data) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(Backdrop, { word: "RUNTIME", ghostTop: 1000, gloss: data.palette.gloss }), _jsxs("div", { className: "relative z-10 p-[72px]", children: [_jsxs("div", { className: "mb-[40px] flex items-center justify-between gap-[24px]", children: [_jsxs("div", { className: "flex items-center gap-[14px] text-[24px] font-extrabold leading-none tracking-[.18em] text-muted", children: [_jsx("span", { className: "size-[11px] flex-none rounded-[9999px]", style: { background: p.rotate[0] } }), _jsx("span", { children: "\u8FD0\u884C\u8BCA\u65AD" }), _jsx("span", { className: "opacity-50", children: "\u00B7" }), _jsx("span", { className: "font-mono", children: "RUNTIME REPORT" })] }), _jsx("div", { className: "flex-none rounded-[9999px] px-[26px] py-[12px] font-mono text-[22px] font-extrabold leading-none tracking-[.1em]", style: {
                                    color: verColor,
