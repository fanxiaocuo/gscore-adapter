...
function Item({ item, color }) {
    return (_jsx("div", { className: "hp-item", children: _jsxs("div", { className: "row", children: [_jsx("div", { className: "ico", style: { background: `${color}1f`, color, border: `1px solid ${color}3d` }, children: _jsx(Icon, { name: item.icon }) }), _jsxs("div", { className: "body", children: [_jsxs("div", { className: "cmd", children: [_jsx("span", { className: "t", children: item.cmd }), item.master && (_jsx("span", { className: "hp-tag", style: { color, background: `${color}1f`, border: `1px solid ${color}3d` }, children: "MASTER" }))] }), _jsx("div", { className: "dsc", children: item.dsc }), item.eg && _jsx("div", { className: "eg mono", children: item.eg })] })] }) }));
}
function Group({ group, color }) {
    const total = group.items.length + (group.subGroups?.reduce((n, s) => n + s.items.length, 0) || 0);
    return (_jsxs("div", { className: "hp-group", children: [_jsxs("div", { className: "hp-group-h", children: [_jsx("div", { className: "bar", style: { background: color } }), _jsx("h2", { children: group.title }), _jsx("div", { className: "n mono", children: String(total).padStart(2, "0") })] }), group.items.length > 0 && (_jsx("div", { className: "hp-items", children: group.items.map((it, i) => (_jsx(Item, { item: it, color: color }, i))) })), group.subGroups?.map((sub, i) => (_jsxs("div", { className: "hp-sub", children: [_jsxs("div", { className: "hp-sub-h", children: [_jsx("span", { className: "d" }), sub.title] }), _jsx("div", { className: "hp-items", children: sub.items.map((it, j) => (_jsx(Item, { item: it, color: color }, j))) })] }, i)))] }));
}
