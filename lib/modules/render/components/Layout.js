 ...
 */
export const GLASS = "[background:linear-gradient(180deg,rgba(255,255,255,.52),rgba(255,255,255,.33)_44%,rgba(255,255,255,.24))] [box-shadow:inset_1px_1px_0_rgba(255,255,255,.95),inset_-1px_-1px_0_var(--border),inset_0_28px_40px_-32px_rgba(255,255,255,.95),0_16px_36px_-22px_rgba(16,26,40,.20)]";
/**
...
export function Empty({ title, tip }) {
    return (_jsxs("div", { className: `flex flex-col items-center justify-center gap-[16px] rounded-[32px] border border-dashed border-border px-[80px] py-[96px] text-center ${GLASS_SOFT}`, children: [_jsx("div", { className: "text-[44px] font-black leading-[1.2]", children: title }), _jsx("div", { className: "text-[26px] leading-[1.7] whitespace-pre-line break-words break-keep text-muted", children: tip })] }));
}
/**
 ...
 */
export function Page({ word, ghostTop, children, }) {
