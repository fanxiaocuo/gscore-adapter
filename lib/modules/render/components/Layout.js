...
export function Stats({ items, palette, }) {
    ...
    return (_jsx("div", { className: "mb-[72px] grid [grid-template-columns:repeat(4,1fr)] gap-[24px]", children: items.map((s, i) => (
        ...
        _jsxs("div", { className: "flex flex-col gap-[6px] rounded-[28px] border border-border bg-surface p-[30px]", children: [_jsx("div", { className: "font-mono text-[19px] font-extrabold uppercase leading-[1.3] tracking-[.16em] text-muted", children: s.key }), _jsx("div", { className: "text-[60px] font-black leading-[1.05] tracking-[-.02em] [font-variant-numeric:tabular-nums]", style: { color: palette.rotate[i % palette.rotate.length] }, children: s.value }), s.sub && _jsx("div", { className: "mt-auto text-[21px] leading-[1.4] text-muted", children: s.sub })] }, i))) }));
}
/**
...
export function Notice({ text, color }) {
    return (_jsx("div", { className: "mb-[44px] rounded-[24px] border border-l-[6px] px-[32px] py-[26px] text-[25px] leading-[1.65] break-words", style: { color, background: `${color}14`, borderColor: `${color}3d` }, children: text }));
}
/** 顶部标题区 */
