...
export function Status(data) {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs(Page, { palette: p, word: data.ghost, children: [_jsx(Header, { title: data.heading, status: "GSCORE_ADAPTER", led: data.mode === "client" ? "on" : "off", rightKey: "RUNNING MODE", rightValue: data.mode }), _jsx("div", { className: "stats", children: data.summary.map((s, i) => (_jsxs("div", { className: "stat", children: [_jsx("div", { className: "k mono", children: s.key }), _jsx("div", { className: "v", style: { color: p.rotate[i % p.rotate.length] }, children: s.value }), s.sub && _jsx("div", { className: "s", children: s.sub })] }, i))) }), data.rows.length === 0 ? (_jsxs("div", { className: "empty", children: [_jsx("div", { className: "t", children: "\u6682\u65E0\u8FDE\u63A5" }), _jsx("div", { className: "d", children: data.emptyTip || "用 #早柚添加连接 <地址> 添加" })] })) : (_jsx("div", { className: "conns", children: data.rows.map(row => {
                        ...
                        }) })), data.panels && data.panels.length > 0 && (_jsx("div", { className: "panels", children: data.panels.map((panel, pi) => (_jsxs("div", { className: "panel", children: [_jsxs("div", { className: "rt-sec", children: [_jsx("span", { className: "dot", style: { background: p.rotate[pi % p.rotate.length] } }), _jsx("span", { className: "t", children: panel.title }), _jsx("span", { className: "ver mono", children: panel.key }), _jsx("span", { className: "line", style: {
                                                background: `linear-gradient(90deg,${p.rotate[pi % p.rotate.length]},transparent)`,
                                            } })] }), _jsx("div", { className: "kv", children: panel.items.map((it, ii) => (_jsxs("div", { className: "row", children: [_jsx("span", { className: "k", children: it.k }), _jsx("span", { className: "v mono", children: it.v })] }, ii))) })] }, pi))) }))] }), _jsx(Footer, { name: data.title, version: data.version, palette: p, lines: [data.time, "#早柚帮助 查看全部指令"] })] }));
}
