 ...
 */
import { PluginPath, PluginName } from "../../dir.js";
import { config, configFile, saveConfig } from "../../config/index.js";
import { reloadClients } from "../../modules/client/index.js";
        ...
        configInfo: {
            ...
            setConfigData(data, { Result }) {
                ...
                if (touchedClient)
                    reloadClients();
                if (needRestart)
                    return Result.ok({}, "保存成功，运行模式或服务端设置需重启云崽生效");
