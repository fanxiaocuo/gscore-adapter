 ...
 */
function tagsInput(content, placeholder, help) {
    return {
        component: "GTags",
        componentProps: {
            allowAdd: true,
...
export const filterSchemas = [
    ...
    },
    {
        ...
        ...tagsInput("请输入要屏蔽的前缀：", "如 #原神", "消息以它开头就不上报，用来把某些指令留给本地插件"),
    },
    {
    ...
    },
    {
        ...
        label: "群白名单",
        bottomHelpMessage: "只上报这些群，留空为全部。列表是所有在线账号已知的群，账号离线时点开是空的 —— 此时存着的群仍在，只是显示成光秃秃的号码（名字查不到）",
    ...
    },
    {
        ...
        label: "用户黑名单（好友里选）",
        bottomHelpMessage: "从账号已知的好友里挑。QQBot 官方号只有私聊过的人才在列表里，挑不到的填下面那栏",
    ...
    },
    {
        ...
        label: "用户黑名单（手动填）",
        bottomHelpMessage: "与上一栏合成同一份名单保存，填平台原样 ID。保存后能在好友列表里查到的会挪到上一栏去",
        // 只校验非空：QQ 号 5-11 位、QQBot openid 32 位十六进制，卡长度只会把非 QQ 平台的 ID 拦在外面
        ...tagsInput("请输入要屏蔽的用户 ID：", "QQ 号 / openid", "上一栏里挑不到的人填这儿，填平台原样 ID"),
    },
];
