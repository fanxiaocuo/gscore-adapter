...
export const DARK: Palette = {
   ...
   * 逐像素统计（test/inkprobe.mjs，采样 50 万点）：
   *
   *   深色背景亮度  p1 L=0.009  p50 L=0.022  p99 L=0.042
   *
   * 浅字的最坏情况是**最亮**的那一档：#8b95a8 在那里只有 3.97:1，掉出 AA。
   * #9ba5b6 是 4.62:1，最暗处仍有 7.15:1（浅字在暗处只会更清楚，不必担心上限）。
   */
  muted: "#9ba5b6",
